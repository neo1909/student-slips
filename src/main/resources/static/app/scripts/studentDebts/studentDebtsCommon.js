    ...
    $('#btnPrint').on('click', function() {
            ...
            <html><head>
			    <link rel="stylesheet" type="text/css">
			        <style>
			            ...
			            .paymentCode{position:absolute;left:446px;top:46px;}
			            .currency{position:absolute;left:496px;top:47px}
			            .amount{position:absolute;top:45px;right:22px;}
			            .account{position:absolute;left:446px;top:94px;}
			            .model{position:absolute;left:446px;top:147px;}
			            .referenceNumber{position:absolute;left:499px;top:146px;}
        ...
        for (let i = 0 ; i < rows.length; i++) {
			...
			<div class="invoice">
			    ...
			    <label class="amount">
			        ${SS.format.formatNumberByLocales(rows[i].amountDebt)}
			    </label>
			    <label class="account">
